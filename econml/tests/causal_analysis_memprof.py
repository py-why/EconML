...
if __name__ == '__main__':
    ...
    def memory_summary():
        ...
        tests.test_basic_array()
        tests.test_basic_pandas()
        tests.test_automl_first_stage()
        tests.test_one_feature()
        tests.test_final_models()
        tests.test_forest_with_pandas()
        tests.test_warm_start()
        tests.test_empty_hinds()
        tests.test_can_serialize()
        tests.test_over_cat_limit()
        tests.test_individualized_policy()
        tests.test_random_state()
        tests.test_can_set_categories()
        tests.test_policy_with_index()
        tests.test_policy_with_index()
        tests.test_invalid_inds()
