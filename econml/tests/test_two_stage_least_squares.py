...
from econml.iv.tsls import (NonparametricTSLS, HermiteFeatures, DPolynomialFeatures)
...
class Test2SLS(unittest.TestCase):
    ...
    def test_2sls(self):
        ...
        for (dt, dx, dz) in [(0, 0, 0), (1, 1, 1), (5, 5, 5), (10, 10, 10), (3, 3, 10), (10, 10, 3)]:
            np2sls = NonparametricTSLS(t_featurizer=HermiteFeatures(dt),
