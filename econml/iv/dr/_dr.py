...
class _BaseDRIVNuisanceSelector(ModelSelector):
    ...
    def train(self, is_selecting, folds, Y, T, X=None, W=None, Z=None, sample_weight=None, groups=None):
        ...
        if self._discrete_treatment:
            T = inverse_onehot(T)
        self._prel_model_effect.fit(Y, T, Z=Z, X=X, W=W, sample_weight=sample_weight, groups=groups)
        return self
...
class _BaseDRIVNuisanceCovarianceSelector(ModelSelector):
    ...
    def train(
        ...
        self._model_tz_xw.train(
            is_selecting, folds, X=X, W=W, Target=target, sample_weight=sample_weight, groups=groups
        )
...
class _IntentToTreatDRIVNuisanceSelector(ModelSelector):
    ...
    def train(self, is_selecting, folds, Y, T, X=None, W=None, Z=None, sample_weight=None, groups=None):
        ...
        self._prel_model_effect.fit(
            Y, inverse_onehot(T), Z=inverse_onehot(Z), X=X, W=W, sample_weight=sample_weight, groups=groups
        )
        return self
