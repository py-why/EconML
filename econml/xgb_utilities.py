...
class XGBWrapper:
    """A simple wrapper of an xgboost tree regressor that supports fit and predict
    sklearn interface, where all parameters are given at init time and not fit time."""
