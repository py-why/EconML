...
**July 31, 2026:** Release v0.17.0, see release notes [here](https://github.com/py-why/EconML/releases/tag/v0.17.0)
...
environment, find an issue to work on, run the tests, and build the
documentation. Maintainer-only tasks -- cutting a release and operating the
dependency-pinning infrastructure -- are in [MAINTAINING.md](MAINTAINING.md).
...
[CONTRIBUTING.md](CONTRIBUTING.md) for development setup, testing, and
